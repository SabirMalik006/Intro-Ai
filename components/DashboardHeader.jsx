      ...
      <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
        ...
        <div className="relative flex-1 lg:flex-none">
          <input
            ...
            className="w-full lg:w-64 px-4 py-3 pl-10 rounded-xl border border-gray-300 dark:border-slate-600 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 focus:outline-none transition-all"
          />
        ...
        <div className="flex gap-3">
          ...
          <Link
            ...
            className="px-6 py-3 bg-gradient-to-r from-teal-600 to-blue-600 text-white rounded-xl hover:from-teal-700 hover:to-blue-700 transition-all duration-300 flex items-center gap-2 font-semibold"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
