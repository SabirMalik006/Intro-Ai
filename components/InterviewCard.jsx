...
export default function InterviewCard({ interview }) {
    const getStatusColor = (status) => {
      switch (status) {
        ...
        case "draft": return "bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-slate-200";
        default: return "bg-gray-100 dark:bg-slate-800 text-gray-700 dark:text-slate-200";
      }
    };
  
    return (
      <div className="bg-white dark:bg-slate-900 rounded-xl border border-gray-200 dark:border-slate-700 p-6 hover:shadow-lg transition-shadow">
        <div className="flex justify-between items-start mb-4">
          <div>
            <h3 className="font-semibold text-gray-900 dark:text-slate-100 text-lg">{interview.title}</h3>
