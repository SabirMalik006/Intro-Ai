  ...
  return (
    <>
      ...
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4">
        <div>
          <h1 className="text-2xl lg:text-3xl font-bold text-gray-900 dark:text-slate-100">Interviews</h1>
          <p className="text-gray-600 dark:text-slate-300 mt-2">Manage and track all your AI interviews</p>
        </div>

        <div className="flex flex-col sm:flex-row gap-4 w-full lg:w-auto">
          <div className="flex gap-2">
            <button className="px-4 py-2 bg-white dark:bg-slate-900 border border-gray-300 dark:border-slate-600 rounded-lg text-gray-700 dark:text-slate-200 hover:bg-gray-50 dark:hover:bg-slate-800 transition-colors">
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          {["all", "active", "scheduled", "completed", "draft"].map((tab) => (
            <button
              ...
              className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors cursor-pointer ${filter === tab
            ...
            >
              ...
              {tab !== "all" && (
                <span className="ml-2 px-2 py-0.5 text-xs bg-white dark:bg-slate-900/20 rounded-full">
      ...
      {filteredInterviews.length === 0 && (
        <div className="text-center py-16">
          ...
          <h3 className="text-xl font-semibold text-gray-900 dark:text-slate-100 mb-2">No interviews found</h3>
