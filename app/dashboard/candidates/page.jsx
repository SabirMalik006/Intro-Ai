      ...
      <main className={`flex-1 transition-all duration-300 ${open ? 'lg:ml-64' : 'lg:ml-20'}`}>
        <div className="p-6 lg:p-8">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center mb-8 gap-4">
            <div>
              <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Candidates</h1>
              <p className="text-gray-600 mt-2">Manage and review all candidate profiles</p>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
            ...
            <div className="bg-white p-4 rounded-xl border border-gray-200">
              ...
              <div className="text-gray-600 text-sm">In Process</div>
            </div>
            <div className="bg-white p-4 rounded-xl border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <button className="p-4 bg-white rounded-xl border border-gray-200 hover:border-teal-300 hover:bg-teal-50 transition-all flex items-center gap-3">
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-gray-600">Send emails to candidates</div>
                </div>
              </button>
              <button className="p-4 bg-white rounded-xl border border-gray-200 hover:border-teal-300 hover:bg-teal-50 transition-all flex items-center gap-3">
                <div className="w-10 h-10 bg-teal-100 rounded-lg flex items-center justify-center">
                ...
                <div className="text-left">
                  ...
                  <div className="text-sm text-gray-600">Create candidate reports</div>
                </div>
              </button>
              <button className="p-4 bg-white rounded-xl border border-gray-200 hover:border-teal-300 hover:bg-teal-50 transition-all flex items-center gap-3">
                <div className="w-10 h-10 bg-teal-100 rounded-lg flex items-center justify-center">
                ...
                <div className="text-left">
                  <div className="font-medium text-gray-900">Import Candidates</div>
                  <div className="text-sm text-gray-600">Import from CSV/LinkedIn</div>
                </div>
              </button>
            </div>
          </div>
